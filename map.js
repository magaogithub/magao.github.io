...
var zoom_ex = new ol.control.ZoomToExtent({
    extent: [
       24.00,13.47, //65.90, 7.48,
       23.45,7.44 //98.96, 40.30
    ]
});
...
$(function() {
    $("#attributes").change(function() {
        ...
        if (value_type == 'xsd:short' || value_type == 'xsd:int' || value_type == 'xsd:double' || value_type == 'xsd:long') {
            ...
            operator1.options[1] = new Option('Plus grand que', '>');
            operator1.options[2] = new Option('Moins que', '<');
            operator1.options[3] = new Option('Égal à', '=');
            operator1.options[4] = new Option('Entre', 'BETWEEN');
        } else if (value_type == 'xsd:string') {
            var operator1 = document.getElementById("operator");
            operator1.options[1] = new Option('Comme', 'ILike');
...
function info() {
    if (document.getElementById("info_btn").innerHTML == "☰ Activer information") {

        document.getElementById("info_btn").innerHTML = "☰ Activer information";
        ...
        document.getElementById("info_btn").innerHTML = "☰ Désactiver information";
...
function clear_all() {
    ...
    if (popup) {
        popup.hide();
                       ...
                       //65.90, 7.48, 98.96, 40.30
    map.getView().fit([ 24.00,13.47,23.45,7.44 ], {
        duration: 1590,
        size: map.getSize()
    });


    document.getElementById("query_panel_btn").innerHTML = "☰ Ouvrir panneau des tâches";
    ...
    document.getElementById("legend_btn").innerHTML = "☰ Afficher la légende";
...
function show_hide_querypanel() {
    ...
    if (document.getElementById("query_tab").style.visibility == "hidden") {
        ...
        document.getElementById("query_panel_btn").innerHTML = "☰ Cacher panneau des tâches";
...
function show_hide_legend() {
    ...
    if (document.getElementById("legend").style.visibility == "hidden") {
        ...
        document.getElementById("legend_btn").innerHTML = "☰ Cacher la légende";
...
measuretype.onchange = function() {
    ...
    map.un('singleclick', getinfo);
    document.getElementById("info_btn").innerHTML = "☰ Activer information";  //Activate GetInfo
    document.getElementById("info_btn").setAttribute("class", "btn btn-success btn-sm");
    if (popup) {
        popup.hide();
    }
